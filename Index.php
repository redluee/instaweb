...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="assets/imgs/instaweb-lines.png">
...
<body>
    ...
    <div class="infotitles">
        ...
        <p class="invisible explore">Explore</p>
        <p class="invisible saved">Saved</p>
        <p class="invisible liked">Liked</p>
        <p class="invisible search">Search</p>
        <p class="invisible account">Account</p>
        <p class="invisible settings">Settings</p>
    </div>
